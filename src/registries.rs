...
use crate::materials::{FireParameters, Material, PhysicsType};
use bevy::{prelude::*, utils::{hashbrown::hash_map::Values, HashMap, HashSet}};
...
impl FromWorld for Registries {
    fn from_world(world: &mut World) -> Self {
        ...
        let reactive_materials = materials.map.values()
